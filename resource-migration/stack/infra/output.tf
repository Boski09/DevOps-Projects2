...
# }
output "lambda_function_01_invoke_arn" {
    value = module.lambda_function_01.lambda_function_invoke_arn
}
output "lambda_function_01_name" {
    value = module.lambda_function_01.lambda_function_name
}
output "lambda_function_05_invoke_arn" {
    value = module.lambda_function_05.lambda_function_invoke_arn
}
output "lambda_function_05_name" {
    value = module.lambda_function_05.lambda_function_name
}
